...
Cleaning the table by converting tmax, tmin and year into numeric type
and seperate date into 3 columns(year,month,day). tmax, tmin and prcp
are set to normal unit for us to read (degree of C and mm).
...
though there is few outliers (14°C in July or -15°C in January, etc.)
